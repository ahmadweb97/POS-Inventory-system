            ...
            <div class="row">
                         ...
                         <div class="col-md-8">
                            <div class="panel panel-purple">
                                <div class="panel-heading"><h3 class="panel-title  text-white">Add Supplier</h3></div>
                                <div class="panel-body">
                                    ...
                                    <form role="form" method="post" action="{{ url('/insert-supplier') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control"  name="address" id="" cols="15" rows="5" placeholder="Supplier Address"></textarea>
                                            @error('address')
                                            <div class="text text-danger">{{ $message }}</div>
                                          @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                           ...
                                           <select name="type" class="form-control" id="">
                                                 <option value="0" disabled selected>--Select Supplier Type--</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <img id="image" src="#" alt="" class="rounded-lg mb-3">
                                        </div>
