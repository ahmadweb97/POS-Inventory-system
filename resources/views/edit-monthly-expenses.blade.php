        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h4 class="pull-left page-title">Edit Expenses</h4>
                         ...
                         <div class="col-md-8">
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    ...
                                    <br>
                                    <form role="form" method="post" action="{{ url('/update-monthly-expenses/'.$editMonthlyExpenses->id) }}" >
                                        @csrf

                                        <div class="form-group">
                                            <label for="detail">Expense Detail</label>
                                         <textarea name="detail" id="" cols="15" rows="5" class="form-control">
                                            {{ $editMonthlyExpenses->detail }}
                                         </textarea>

                                        </div>
                                        <div class="form-group">
                                            <label for="amount">Expense Amount($)</label>
                                            <input type="text" class="form-control" name="amount" value="{{ $editMonthlyExpenses->amount }}">
